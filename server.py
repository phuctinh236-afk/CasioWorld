...
GAME_CATALOG = {
    "dragon-gems": ("Dragon Gems 500", "assets/dragon_gems.jpg"),
    "mithai-madness": ("Mithai Madness", "assets/mithai_madness.jpg"),
    "fortune-ganesha": ("Fortune Ganesha", "assets/fortune_garuda.jpg"),
    "ncvip-super": ("NCVIP Super Elements", "assets/ncvip_super.jpg"),
    "ultra-ace": ("Ultra Ace", "assets/ultra_ace.jpg"),
    "ncvip-gates": ("Gates of Olympus", "assets/ncvip_gates.jpg"),
    "bountiful-birds": ("NC Bountiful Birds", "assets/bountiful_birds.jpg"),
    "treasures-aztec": ("Treasures of Aztec", "assets/treasures_aztec.jpg"),
    "wild-bounty": ("Wild Bounty", "assets/wild_bounty.jpg"),
    "dragon-gems-wheel": ("Dragon Gems Wheel", "assets/dragon_gems_wheel.jpg"),
    "pinata-wins": ("Pinata Wins", "assets/pinata_wins.jpg"),
    "jackpot-fishing": ("Jackpot Fishing", "assets/jackpot_fishing.jpg"),
    "super-niubi": ("Super Niu Niu", "assets/super_niubi.jpg"),
    "lucky-neko": ("Lucky Neko", "assets/lucky_neko.jpg"),
    "chinese-new-year": ("Chinese New Year", "assets/chinese_new_year.jpg"),
    "chicken-drop": ("Chicken Drop", "assets/chicken_dash.jpg"),
    "daga": ("Đá Gà", "assets/daga_ws151.jpg"),
}
    ...
    if(!users.length){
        ...
        users.forEach(u=>{
            ...
            <tr style="${rowStyle}">
                ...
                <td>${statusTxt}</td>
                <td>
                    <input id="amount-${u.id}" type="number" class="input-small" placeholder="Casino" min="1">
                    <button class="btn btn-add" onclick="modifyFC(${u.id},1)">+</button>
                    <button class="btn btn-sub" onclick="modifyFC(${u.id},-1)">-</button>
                </td>
                <td style="white-space:nowrap">${lockBtn} ${roleBtn}</td>
            </tr>`;
        });
    }
...
def admin_api_modify_fc():
    ...
    if abs(amount) > 10_000_000:
        return jsonify({
            "message": "Mỗi lần chỉ được thay đổi tối đa 10.000.000 Casino"
        }), 400
